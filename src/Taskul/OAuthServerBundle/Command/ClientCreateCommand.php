<?php
    namespace Taskul\OAuthServerBundle\Command;
    ...
    use Taskul\OAuthServerBundle\Document\Client;
    ...
    class ClientCreateCommand extends ContainerAwareCommand
    {
        ...
        {
            $this
                ->setName('taskul:oauth-server:client:create')
...
EOT
        ...
        protected function execute(InputInterface $input, OutputInterface $output)
        {
            ...
            $output->writeln(sprintf('Added a new client with name <info>%s</info> and public id <info>%s</info>, secret <info>%s</info>.', $client->getName(), $client->getPublicId(),$client->getSecret() ));
        }
    }